...
The $2M we're raising has two specific destinations: two additional engineers to accelerate the reliability and routing infrastructure, and SOC 2 certification. That certification is the unlock for enterprise contracts. We're already in conversations with three companies that can't sign until we have it.
