...
- **Problem 1 & 2 (editorial preamble / word count):** Removed the entire revision-log preamble. The deliverable is the memo only.
- **Problem 3 (FedRAMP absent):** Added FedRAMP as a motivating compliance citation in Prohibited Use #1, alongside DPA and SOC2.
- **Problem 4 (GDPR absent):** Added GDPR as a motivating compliance citation in Prohibited Use #1.
- **Problem 5 (sales prohibition unworkable on day one):** Added a 30-day provisional window for sales staff using AI for email drafting, with mandatory manager attestation, giving current users a defined compliance path while a tool-approval decision is pending.
- **Problem 6 (SOC2 not used as motivating fact for prohibitions):** Added SOC2 Type II as a motivating citation in Prohibited Use #1.
- **Problem 7 (mandatory notification conflates SOC2 with law):** Replaced "mandatory notification under SOC2 incident-response procedures" with "notification obligations under GDPR and applicable breach-notification law, assessed by Legal."
