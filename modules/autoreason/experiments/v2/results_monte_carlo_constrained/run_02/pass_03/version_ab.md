...
5. Engineering Leads flag license artifacts during code review (Prohibited Use #3) and FedRAMP workstream violations (Prohibited Use #6); IT enforces Slack AI feature access via existing administrative controls (Prohibited Use #5).