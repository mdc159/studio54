...
5. **No employee may request or self-enable Slack AI features.** IT maintains the disabled state through existing administrator controls. *(Motivating fact: the approved tool list specifies Slack with AI features disabled.)*
