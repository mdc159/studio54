...
3. This policy operates within the company's SOC2 Type II, GDPR, and pending FedRAMP compliance obligations.
...
5. **No re-enabling Slack AI features.** Employees must not re-enable any AI feature within the company Slack instance. *(Doing so constitutes use of a third-party AI service, risking violation of existing DPA terms per outside counsel; SOC2 Type II certification; pending FedRAMP authorization.)*
