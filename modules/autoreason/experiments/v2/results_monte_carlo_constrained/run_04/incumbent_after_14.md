...
2. **No unapproved AI tools.** Using any AI tool not listed under Permitted Uses is prohibited for all roles. Sales staff currently using AI tools for email drafting must cease use of unapproved tools immediately. *(Motivating facts: Incident #2 — sales rep used an unapproved AI tool to draft email copy containing a competitor's copyrighted marketing copy; outside counsel flagged DPA violation risk from third-party AI services; informal survey confirmed 73% of engineers and 45% of sales staff currently use unapproved AI tools.)*
