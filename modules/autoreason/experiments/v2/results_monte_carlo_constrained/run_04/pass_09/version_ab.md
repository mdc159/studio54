...
4. Sales staff may use AI writing tools for email drafting only if Legal has approved the specific tool in writing before first use, within the $50K annual AI tooling budget. Legal maintains and publishes the current approved-tools list. All AI-generated text must be reviewed and edited by the authoring employee before transmission.
