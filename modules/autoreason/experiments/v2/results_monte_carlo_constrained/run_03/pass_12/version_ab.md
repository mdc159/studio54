...
1. **No customer data in external AI services.** Inputting customer PII, financial data, or customer-identifiable information (including database schemas) into any non-approved AI service is prohibited. *(Incident 1 — engineer pasted a customer database schema into ChatGPT; outside counsel finding that doing so violates existing DPA terms; SOC2 Type II certification; GDPR obligations for EU customers.)*
...
3. Engineering leadership logs the incident before any merge proceeds; no non-compliant merge advances without that log entry.
...
5. Managers who identify use of unapproved AI tools or Slack AI circumvention (Prohibited Uses 4, 5) revoke access to the service and notify Security and Legal.
