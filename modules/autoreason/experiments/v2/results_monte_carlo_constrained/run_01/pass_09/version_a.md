...
- **Problem 1 (word count):** Collapsed audit trail items into their corresponding prohibition basis notes; removed invented deadlines, PIP language, and the Finance recordkeeping item; tightened all prose.
- **Problem 2 (prose paragraphs in Enforcement):** Broke the graduated-consequences item into three discrete numbered items.
- **Problem 3 (Prohibition #5 scope overreach):** Narrowed the prohibition to code specifically, and limited scope to contracts and deliverables only—removing "filings," which was not derivable.
- **Problems 4, 5, 6, 7, 8 (invented content):** Removed the one-business-day/five-business-day deadlines, PIP language, Legal's interpretive authority, Finance recordkeeping role, and CRM reference.
- **Problem 9 (sales AI use unaddressed):** Added a Permitted Uses item explicitly addressing sales staff AI drafting tools and conditions.
- **Problem 10 (circular audit trail for Prohibition #1):** Replaced the circular Copilot-log reference with a manager-attestation mechanism using existing HR incident records.
- **Problem 11 (duplicate rule):** Removed the license-header rejection rule from Permitted Uses #3; it lives solely in Prohibited Uses #3.
...
4. Sales staff may use AI writing assistance for email drafting only through tools approved under item 5 below; all AI-drafted external communications require human review before sending.
...
5. **No representation of AI-generated code as independently copyrightable company IP** in contracts or customer deliverables. *[Basis: Outside counsel flagged that AI-generated code may not be copyrightable; Incident 3 demonstrated that AI output can carry third-party IP encumbrances.]*
