...
5. **Slack AI features remain disabled.** No employee may enable AI features within company Slack. *[Basis: AI features in company Slack are currently disabled per company configuration; enabling them would risk exposure of customer data to third-party AI services in violation of existing DPA terms, GDPR obligations, and pending FedRAMP authorization.]*
...
4. Manager review is mandatory for all confirmed violations and must occur within five business days of Legal's confirmation. This requirement applies to all employees regardless of whether they hold an approved AI tool seat.
