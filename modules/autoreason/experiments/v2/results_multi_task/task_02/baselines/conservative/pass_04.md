...
- 15-minute batching windows to reduce notification fatigue
...
class BatchProcessor:
    def __init__(self):
        self.batch_size = 5   # Smaller limit for better UX
        self.batch_timeout = 900  # 15 minutes for better summarization
...
**Rationale**: 15-minute windows and smaller batch sizes (5 vs 10) reduce notification fatigue while providing better summarization opportunities. This balances user experience with system efficiency.
...
**Rationale**: Longer windows enable better summarization and reduce notification fatigue, while smaller batch sizes maintain readability and user engagement.
