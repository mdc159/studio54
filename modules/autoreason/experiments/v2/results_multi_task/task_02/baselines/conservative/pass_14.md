...
- 15-minute batching windows for optimal balance of cost and responsiveness
- Up to 5 notifications per batch per user to avoid overwhelming users
...
**Rationale**: 15-minute batching windows provide good cost savings while remaining reasonable for social interactions. Users don't expect instant notifications for likes/comments.
...
**Capacity Planning**:
- Peak load: 50,000 notifications/minute (assuming 5% DAU peak engagement)
...
**Rationale**: Provides meaningful cost savings while remaining acceptable for social interactions. Users don't expect instant notifications for likes/comments.
