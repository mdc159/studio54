...
- 5-minute batching windows for better responsiveness
...
class BatchProcessor:
    def __init__(self):
        self.batch_size = 5
        self.batch_timeout = 300  # 5 minutes for better responsiveness
...
**Rationale**: 5-minute windows provide better responsiveness while still enabling useful batching. This balances user experience with system efficiency for a social app where engagement timing matters.
...
**Decision**: 5 minutes for low-priority notifications with 5-notification limit
**Rationale**: Shorter windows provide better responsiveness for social interactions while still enabling useful batching and reducing notification fatigue.
