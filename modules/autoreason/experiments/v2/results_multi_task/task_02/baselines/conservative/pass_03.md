...
- Up to 10 notifications per batch per user
- Intelligent deduplication and summarization

```python
class BatchProcessor:
    def __init__(self):
        self.batch_size = 10  # Per user limit for social app responsiveness
...
**Rationale**: Smaller batch sizes (10 vs 20) and shorter windows better suit social app engagement patterns where users expect timely notifications about social interactions.
