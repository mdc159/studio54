...
**EU Team Structure (4 engineers + 1 incident commander):**
```
Primary On-Call Teams:
Pod EU-A: Senior SRE (Thomas Mueller) + Full-stack Engineer (Sophie Dubois)
Pod EU-B: Platform Engineer (Lars Andersson) + Backend Lead (Elena Popov)
...
├── Severity 1/2: Personal calls to all affected enterprise customers within 10 minutes
├── Technical Contact: Direct engineer-to-engineer communication for complex issues
├── Executive