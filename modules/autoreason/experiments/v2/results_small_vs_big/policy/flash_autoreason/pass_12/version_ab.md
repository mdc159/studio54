...
3.  Any other AI-powered software or service used to automate or augment work tasks (e.g., marketing content generation, HR chatbots).

**2. Permitted Uses**

The following uses of AI tools are permitted, subject to the restrictions outlined in Section 3:

1.  Use of GitHub Copilot Business subject to license availability (Base Fact: Already licensed). Employees can check license availability on the Engineering Team's internal wiki. If all 80 licenses are in use, employees must relinquish their license when not in use, or wait until one becomes available.
...
6. The Security Team will conduct quarterly audits of a sample of code commits and sales emails to ensure compliance with this policy, reporting findings to the executive team.
