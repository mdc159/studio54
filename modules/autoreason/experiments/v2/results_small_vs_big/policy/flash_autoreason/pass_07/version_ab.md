...
6.  Committing AI-generated code to the codebase without review by an engineer with at least two years of experience at the company (Base Fact: Legal review regarding copyrightability).

**4. Enforcement**

Violations of this policy may result in disciplinary action, up to and including termination of employment or contract.

1.  Engineering managers will review code commits for license compliance and escalate any potential copyright infringement issues flagged during code review to the Legal Department.
