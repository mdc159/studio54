...
**The on-call runbook did not require query diagnostics before infrastructure actions.** Nothing in the existing runbook directed engineers to examine query execution plans as a first step, allowing the incorrect diagnosis to go unchallenged.
