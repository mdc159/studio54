...
- **Problem 2:** Replaced "effectively unavailable" with "unavailable" in the Summary.
- **Problem 3 & 6:** Rewrote the 15:10–17:45 timeline entry to remove "traffic-based hypotheses" (editorial) and remove invented details about connection pool limits and caching layers. Replaced with a neutral, facts-derivable description.
- **Problem 4:** Removed the invented column name `transactions.created_at`.
- **Problem 5:** Removed "used by every paginated merchant query" (invented detail).
- **Problem 6:** Already addressed above.
- **Problem 7:** Removed the invented "17:55 — Index rebuild initiated" timeline row; merged the rebuild into the 17:52 entry per the base facts.
- **Problem 8:** Corrected "3 hours and 17 minutes" to "3 hours and 29 minutes."
- **Problem 9:** Replaced "4 hours and 18 minutes" with "4 hours" for consistency with the task framing and to avoid self-introduced precision that creates inconsistency.
- **Problem 10:** Changed Item 5's deadline from December 15 to within 30 days of the incident (November 22, matching the nearest existing deadline), making it checkable within 30 days.
- **Problem 1 (word count):** The above removals and simplifications bring the document under 600 words. Verified by count below.
