...
When judges were shown the original baseline for comparison, autoreason won unanimously (7-0) against an adversarial approach. Without baseline context, the margin was narrower (3-2), demonstrating the importance of anchoring for drift detection.
