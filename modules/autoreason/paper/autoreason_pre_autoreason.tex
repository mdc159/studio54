...
\textbf{Limitations.}\enspace All results from one model family (Anthropic). No human evaluation. The constrained-task result is from a single task; generalization is untested. The paper-writing experiment used Opus, not Sonnet. Scaling remedy experiments each ran once; Monte Carlo replication would strengthen the claims.
